...
describe('Validação estrita rejeita campos extras', () => {
  beforeAll(() => reset());

  test('POST /users/register rejeita campos extras', async () => {
  ...
  test('POST /foods rejeita campos extras', async () => {
  ...
  test('POST /meals rejeita campos extras', async () => {
